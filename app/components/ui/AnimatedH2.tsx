...
export function AnimatedH2({ className = "", children }: { className?: string; children: React.ReactNode }) {
  return (
    <MotionH2
      className={clsx("text-4xl tracking-tighter text-slate-900 dark:text-white transition-colors duration-300 md:text-5xl md:leading-13 lg:text-6xl lg:leading-15", className)}
      variants={container}
      initial="hidden"
      whileInView="show"
